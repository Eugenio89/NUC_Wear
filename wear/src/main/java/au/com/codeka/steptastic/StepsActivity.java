...
public class StepsActivity extends Activity {
  ...
  public static final String EXTRA_PASOS = "au.com.codeka.steptastic.EXTRA_PASOS";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //Con esta mando la variable a la otra actividad
      Intent i = new Intent(getApplicationContext(), Pasos.class);
      i.putExtra(EXTRA_PASOS,steps);
      startActivity(i);
        //Hasta aqui
